...
time cargo run --release -- -a ../assets/both\ parts.bgcode > both.obj
time cargo run --release -- -a ../assets/mini_cube_b.bgcode > mini_cube_b.obj
time cargo run --release -- -a ../assets/benchy2-mk4s.bgcode > benchy2-mk4s.obj
# Rounded corners
time cargo run --relase --  -a ../assets/g3_box_rounded_anticlockwise.gcode > g3_box_rounded_anticlockwise.obj
# nibble - a corner cut out.
time cargo run --release -- -a ../assets/g2_box_nibble_clockwise.gcode > g2_box_nibble_clockwise.obj
# mix of clockwise and anti-clockwise
time cargo run --release -- -a ../assets/arc_demo.gcode > arc_demo.obj
time cargo run --release -- -a ../assets/gear-holder-print-in-place_04n_022mm_pla_mk4_6h49m.bgcode > gear-holder.obj
